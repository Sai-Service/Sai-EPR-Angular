...
@Component({
  selector: 'app-ar-receipt-ins',
  templateUrl: './ar-receipt-ins.component.html',
  styleUrls: ['./ar-receipt-ins.component.css']
})
export class ArReceiptInsComponent implements OnInit {
        ...
        data => {
          if (data.code === 200) {
            ...
            if (data.obj.length=1){
               this.CustAccountNoSearch(data.obj[0].accountNo);
            }
          }
          else {
            if (data.code === 400) {
          ...
          data => {
            ...
            if (data.obj.length === 0) {
              ...
              this.paymentArForm.patchValue({
                ...
                custSiteName: this.accountNoSearch[0].siteName,
                customerSiteId:this.accountNoSearch[0].customerSiteId,
               
              });
              this.onOptionsSelectedcustSiteName(this.accountNoSearch[0].siteName)
              // alert(this.accountNoSearch[0].siteName)
