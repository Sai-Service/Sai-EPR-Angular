...
@Component({
  selector: 'app-pump-employee-master',
  templateUrl: './pump-employee-master.component.html',
  styleUrls: ['./pump-employee-master.component.css']
})
export class PumpEmployeeMasterComponent implements OnInit {
