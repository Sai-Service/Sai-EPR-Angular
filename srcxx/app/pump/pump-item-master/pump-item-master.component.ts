...
@Component({
  selector: 'app-pump-item-master',
  templateUrl: './pump-item-master.component.html',
  styleUrls: ['./pump-item-master.component.css']
})
export class PumpItemMasterComponent implements OnInit {
