...
@Component({
  selector: 'app-pump-customer-master',
  templateUrl: './pump-customer-master.component.html',
  styleUrls: ['./pump-customer-master.component.css']
})
export class PumpCustomerMasterComponent implements OnInit {
