...
@Component({
  selector: 'app-pump-pricelist-master',
  templateUrl: './pump-pricelist-master.component.html',
  styleUrls: ['./pump-pricelist-master.component.css']
})
export class PumpPricelistMasterComponent implements OnInit {
