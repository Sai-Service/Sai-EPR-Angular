...
@Component({
  selector: 'app-tools-purchase-order',
  templateUrl: './tools-purchase-order.component.html',
  styleUrls: ['./tools-purchase-order.component.css']
})



// export class OPMasterDtoComponent implements OnInit {
  export class ToolsPurchaseOrderComponent implements OnInit {
  supSelCnt: number;
  isDisabled = true;
  discLineAmt: number;
  accountLocId:number;
...
;
  ...
  constructor(private fb: FormBuilder, private router1: ActivatedRoute, private router: Router, private service: MasterService) {
    this.ToolsMasterPOForm = this.fb.group({
  ...
  get f() { return this.ToolsMasterPOForm.controls; }
  ...
  ngOnInit(): void {
    ...
    this.ToolsMasterPOForm.patchValue({ divisionName: (sessionStorage.getItem('divisionName')) })
    ...
    this.service.DepartmentListById(this.dept)
      .subscribe(
        data => {
          ...
          // this.ToolsMasterPOForm.patchValue(this.DepartmentListById.divisionName);
    ...
    this.service.getLocationSearch1(this.ouId)
      .subscribe(
        data => {
          ...
          this.ToolsMasterPOForm.patchValue({shipToLoc:locCodeLosi.locId});
        }
      );
    ...
    this.service.getLocationSearch1(this.ouId)
      .subscribe(
        data => {
          ...
          console.log(locCodeLosi.locId);
          this.ToolsMasterPOForm.patchValue({billToLoc:locCodeLosi.locId});
        }
      );
    ...
    this.sub = this.router1.params.subscribe(params => {
      ...
      this.ToolsMasterPOForm.patchValue({ segment1: this.poNo })
        ...
        .subscribe(
          data => {
            ...
            if (data.code === 400) {
              ...
              let control3 = this.ToolsMasterPOForm.get('poLines') as FormArray;
              ...
              this.ToolsMasterPOForm.patchValue({ approveDate: approveDate2 });
              var poDate1 = data.obj.poDate;
              var poDate2 = this.pipe.transform(poDate1, 'dd-MM-yyyy');
              this.ToolsMasterPOForm.patchValue({ poDate: poDate2 });
              // alert(approveDate2);
              ...
              if (status === 'Inprogress') {
                ...
                var control = this.ToolsMasterPOForm.get('poLines') as FormArray;
                var taxcatecontrol = this.ToolsMasterPOForm.get('poLines') as FormArray;
                console.log(control);
                ...
                this.ToolsMasterPOForm.patchValue(this.lstcomments1, { emitEvent: false });
              ...
              if (status === "APPROVED") {
                ...
                let control = this.ToolsMasterPOForm.get('poLines') as FormArray;
                for (let i = 0; i <= this.lstcomments1.poLines.length - lenC; i++) {
                  var poLine: FormGroup = this.lineDetailsGroup();
                ...
                var len = this.lstcomments1.poLines.length - 1
                this.lineDetailsArray.removeAt(len);
                this.ToolsMasterPOForm.patchValue(this.lstcomments1);
              ...
              if (status === "CANCELLED") {
                ...
                this.displayNewButton = false;
                this.displaygoReceiptForm = false;
                this.ToolsMasterPOForm.disable();
                this.approvedArray = this.lstcomments1.poLines;
                console.log(this.approvedArray);
                this.isVisible = false;
  ...
  //   onChanges(): void {
  //     this.ToolsMasterPOForm.valueChanges.subscribe(val => {
  //
  //   });
  // }
  ...
  get lineDetailsArray() {
    ...
    return <FormArray>this.ToolsMasterPOForm.get('poLines')
  }
  ...
  addRow(index) {
    // var arrayControl = this.ToolsMasterPOForm.get('poLines').value;
    var arrayControlNew = this.ToolsMasterPOForm.get('poLines') as FormArray;
...
// debugger
    ...
    var formArr = this.ToolsMasterPOForm.get('poLines') as FormArray;
    var formVal = this.ToolsMasterPOForm.get('poLines').value;
  ...
  updateTotAmtPerline() {
    ...
    this.ToolsMasterPOForm.patchValue({ 'baseAmount': basicAmt });
    disAmt = Math.round(((disAmt) + Number.EPSILON) * 100) / 100;
    //this.ToolsMasterPOForm.patchValue({ 'discAmt': disAmt });
    taxAmt1 = Math.round(((taxAmt1) + Number.EPSILON) * 100) / 100;
    this.ToolsMasterPOForm.patchValue({ 'totTaxAmt': taxAmt1 });
    totAmt = Math.round(((totAmt) + Number.EPSILON) * 100) / 100;
    this.ToolsMasterPOForm.patchValue({ 'totalAmt': totAmt });
  ...
  Search(poNo) {
    ...
    console.log(this.ToolsMasterPOForm.value);
  ...
  newPOMast() {
    ...
    const formValue: IpostPO = this.transData(this.ToolsMasterPOForm.getRawValue());
  ...
  onOptionTaxCatSelected(i,event) {
    ...
    // var tacCategoryControl = this.ToolsMasterPOForm.get('poLines').value;
    var tacCategoryControlNew = this.ToolsMasterPOForm.get('poLines') as FormArray;
    ...
    // var taxCategoryName=this.ToolsMasterPOForm.get('taxCategoryName').value;
    // alert('******'+ i+'----'+ taxCategoryName);
    if (taxCategoryName != null) {
      // var taxCategoryId=this.ToolsMasterPOForm.get('taxCategoryId').value;
      var patch = this.ToolsMasterPOForm.get('poLines') as FormArray;
      ...
      // var itemId=this.ToolsMasterPOForm.get('itemId').value;
          ...
          this.service.ItemDetailsList(this.invItemId, this.selSuppTaxCatNm, this.billToLoc).subscribe((res: any) => {
            if (res.code === 200) {
              if (res.obj.itemId === null) {
                ...
                var patch = this.ToolsMasterPOForm.get('poLines') as FormArray;
                (patch.controls[index]).patchValue({ segment: ' ',  });
                ...
                // alert(gstPercentage)
                // var supplierSiteId = this.ToolsMasterPOForm.get('supplierSiteId').value;
                // console.log(this.suppIdList);
                // let selectedValue = this.suppIdList.find(v => v.suppSiteId == supplierSiteId);
                // console.log(selectedValue);

                // const toolsinvCategory = this.ItemDetailsList.invCategory.substr(0, 3);
                //   const toolsinvCategory = this.ItemDetailsList.invCategory
                // if (toolsinvCategory === 'MASPR.TOOLS') {
                //     this.service.getItemOldPrice(this.invItemId,'Maruti Tools 11MU - NDP').subscribe((res: any) => {
                // if (res.code === 200) {
                //     if (res.obj.itemId === null) {
                //       alert('Item Or PO Charge Account Not Found in Master !')
                //       var patch1 = this.ToolsMasterPOForm.get('poLines') as FormArray;
                //       (patch1.controls[index]).patchValue({ segment: ' ',  });
            ...
            //======================================================================================
               const toolsinvCategory = this.ItemDetailsList.invCategory
               var plNam ='Maruti Tools 11MU - NDP';
                if (toolsinvCategory === 'MASPR.TOOLS') {
                // alert ("relItemCode : " + relItemCode);
                this.service.getItemOldPrice(this.invItemId,plNam).subscribe(data =>{
                  // alert(data[0].priceValue)

                var patch1 = this.ToolsMasterPOForm.get('poLines') as FormArray;
                (patch1.controls[index]).patchValue({ unitPrice: data[0].priceValue,  });
  ...
  fnCancatination(index) {
    ...
    arrayControl[index].segmentName = this.ToolsMasterPOForm.get('segment11').value + '.'
      + this.ToolsMasterPOForm.get('segment2').value + '.'
      + this.ToolsMasterPOForm.get('segment3').value + '.'
      + this.ToolsMasterPOForm.get('segment4').value + '.'
      + this.ToolsMasterPOForm.get('segment5').value;
    // + this.ToolsMasterPOForm.get('segment6').value;
    //  + this.ToolsMasterPOForm.get('segment7').value + '.'
    //  + this.ToolsMasterPOForm.get('segment8').value + '.'
    //  + this.ToolsMasterPOForm.get('segment9').value  ;
    ...
    this.ToolsMasterPOForm.get('segment11').reset();
    this.ToolsMasterPOForm.get('segment2').reset();
    this.ToolsMasterPOForm.get('segment3').reset();
    this.ToolsMasterPOForm.get('segment4').reset();
    this.ToolsMasterPOForm.get('segment5').reset();
    // this.ToolsMasterPOForm.get('segment6').reset();
    this.ToolsMasterPOForm.get('lookupValueDesc1').reset();
    this.ToolsMasterPOForm.get('lookupValueDesc2').reset();
    this.ToolsMasterPOForm.get('lookupValueDesc3').reset();
    this.ToolsMasterPOForm.get('lookupValueDesc4').reset();
    this.ToolsMasterPOForm.get('lookupValueDesc5').reset();
  }

  updatePOLineAmt(index){

    // var patch = this.ToolsMasterPOForm.get('poLines') as FormArray;
    // var trxLnArrNew = this.ToolsMasterPOForm.get('poLines') as FormArray;
    // var trxLnArr = trxLnArrNew.getRawValue();
 
    //  (patch.controls[index]).patchValue({discLineAmt: dissamt, });
  ...
  onKey(index,event) {
    ...
    var trxLnArrNew = this.ToolsMasterPOForm.get('poLines') as FormArray;
    var trxLnArr = trxLnArrNew.getRawValue();
    var trxLnArr1 = this.ToolsMasterPOForm.get('poLines') as FormArray
    ...
    if (taxCatName.includes('Disc')) {
      ...
      // var discP= trxLnArr[index].discLinePer;
      var discLinePer=Number(trxLnArr[index].attribute5)
      
      if(discLinePer >0) {

         var dissamt =baseAmount * (discLinePer)/100;
        (patch.controls[index]).patchValue({discLineAmt: dissamt, });
      ...
      this.lineDetailsArray.controls[index].get('attribute5').enable();

    }

    else {
      this.lineDetailsArray.controls[index].get('discLineAmt').disable();
      this.lineDetailsArray.controls[index].get('attribute5').disable();

      var discLineAmt = trxLnArr[index].discLineAmt;
      var diss = discLineAmt;
        (patch.controls[index]).patchValue({discLineAmt: 0, });
        (patch.controls[index]).patchValue({attribute5: 0, });

    }
    if (baseAmount != null) {
      console.log(trxLnArr[index].baseAmtLineWise);
      console.log((this.ToolsMasterPOForm.controls['poLines'][index]));
  ...
  validateDiscP(index) {
    ...
    var trxLnArr = trxLnArrNew.getRawValue();
        ...
        var discP = Number(trxLnArr[index].attribute5); 
        var baseAmount=trxLnArr[index].baseAmtLineWise;

    // alert ("index, baseAmount,tp ,discp,discA>> "+ index +","+baseAmount +","+tp +","+discP)


      if(discP>0) {
        var dissamt =baseAmount * (Number(trxLnArr[index].attribute5))/100;
        (patch.controls[index]).patchValue({discLineAmt: dissamt, });
        (patch.controls[index]).patchValue({attribute5: discP, });
  ...
  validateDiscA(index) {
    ...
    var trxLnArrNew = this.ToolsMasterPOForm.get('poLines') as FormArray;
    var trxLnArr = trxLnArrNew.getRawValue();
    var discP=0;var discA=0;
   
      discA = trxLnArr[index].discLineAmt; 
      var baseAmount=trxLnArr[index].baseAmtLineWise;

    // alert ("index, baseAmount,tp ,discp,discA>> "+ index +","+baseAmount +","+tp +","+discA)

           if(trxLnArr[index].discLineAmt>0) {
          var dissp =(trxLnArr[index].discLineAmt /baseAmount)*100;
          (patch.controls[index]).patchValue({attribute5: dissp ,});
          (patch.controls[index]).patchValue({discLineAmt: discA, });
        ...
        this.onKey(index,discA);

  }

  validate(index: number) {
    var trxLnArr = this.ToolsMasterPOForm.get('poLines').value;
    var orderedQty = trxLnArr[index].orderedQty;
    var uomCode = trxLnArr[index].uom;
    if (uomCode === 'NO') {
  ...
  UpdatePOMast() {
    this.supplierCode = this.ToolsMasterPOForm.get('supplierCode').value

    // const formValue: IpostPO = this.transUpdateData(this.ToolsMasterPOForm.value);
    const formValue: IpostPO = this.transUpdateData(this.ToolsMasterPOForm.getRawValue());
    ...
    // var arrayControl = this.ToolsMasterPOForm.get('poLines').value;
    var arrayControl1 = this.ToolsMasterPOForm.get('poLines') as FormArray;
  ...
  Approve() {
    ...
    // this.displayNewButtonSave = false;
    // this.displayNewButtonReset = false;
    const formValue: IpostPO = this.transUData(this.ToolsMasterPOForm.value);
    formValue.ouId = this.ouId;
    formValue.dept = Number(this.dept);
    formValue.currencyCode = 'INR';
  ...
  addDiscount(i) {
    // alert(i);
    // alert('hi')
    const formValue: IpostPO = this.ToolsMasterPOForm.value;
    ...
    var baseAmount = arrayControl[this.poLineTax].baseAmtLineWise;
    // alert(diss1);
    var discAmtcontrol = this.ToolsMasterPOForm.get('poLines') as FormArray;
  ...
  onOptioninvitemTypeSelected(e: any, lineNum) {
    ...
    if (this.ToolsMasterPOForm.get('supplierCode').value === '' || this.ToolsMasterPOForm.get('shipToLoc').value === null
      || this.ToolsMasterPOForm.get('suppInvNo').value === null || this.ToolsMasterPOForm.get('suppInvDate').value === null
      || this.ToolsMasterPOForm.get('billToLoc').value === undefined || this.ToolsMasterPOForm.get('suppInvNo').value === undefined
      || this.ToolsMasterPOForm.get('suppInvDate').value === undefined) {
      alert('Please Select Header Deatils !');
      this.lineDetailsArray.controls[lineNum].get('itemType').setValue('--Select--');
      (<any>this.ToolsMasterPOForm.get('supplierCode')).nativeElement.focus();
      return;
    }
    else {
      if (itemType === 'GOODS') {
        var deptName1 = this.ToolsMasterPOForm.get('dept').value;
        this.lineDetailsArray.controls[lineNum].get('segment').disable();
        ...
        this.ToolsMasterPOForm.get('supplierCode').disable();
        this.ToolsMasterPOForm.get('supplierSiteId').disable();
        this.ToolsMasterPOForm.get('shipToLoc').disable();
        this.ToolsMasterPOForm.get('billToLoc').disable();
        this.ToolsMasterPOForm.get('suppInvNo').disable();
        this.ToolsMasterPOForm.get('suppInvDate').disable();
  ...
  Apply() {
    const formValue: IpostPO = this.transData(this.ToolsMasterPOForm.value);
  ...
  clearFormArray() {
    ...
    // this.ToolsMasterPOForm.lineDetailsGroup.TaxDetailsArray.clear();
  ...
  ToolsMasterPO(ToolsMasterPOForm) { }
  ...
  onOptionsSelectedBranch(segment: any, lType: string) {
    ...
    this.service.getInterBranch(segment, lType).subscribe(
      data => {
        ...
        if (this.branch != null) {
          // this.ToolsMasterPOForm.patchValue(this.branch);
  ...
  validateNum(index, j) {
    ...
    // this.ToolsMasterPOForm.get('poLines').value
    ...
    if (value.charAt(0) === '-') {
      ...
      // this.ToolsMasterPOForm.controls['poLines'].controls[index].controls['taxAmounts'].controls[j].controls.totTaxPer.value
  ...
  getMessage(msgType: string) {
    ...
    if (msgType.includes("Save")) {
      ...
      if (this.ToolsMasterPOForm.invalid) {
 ...
 suppInvDetail(suppNo){
    // alert(suppNo);
    var supp=this.ToolsMasterPOForm.get('supplierCode').value;
      var value = supp.substr(supp.indexOf('@') + 1, supp.length);
      // alert(value)
       let selectedValue = this.supplierCodeList.find(v => v.suppNo == value);
     console.log(selectedValue);
    ...
    this.service.suppInvDetailFn(suppNo,selectedValue.suppId).subscribe((res: any) => {
            if (res.code === 200) {
              ...
              if (res.obj.cnt <=1){
                this.ToolsMasterPOForm.patchValue({poInvMes:res.obj.mes});
                this.isDisabledSave=true;
              }
              else{
                this.isDisabledSave=false;
               if (this.ToolsMasterPOForm.get('poInvMes').value != null){
                this.ToolsMasterPOForm.get('poInvMes').reset();
               }
              }
            } else {
              if (res.code === 400) {
