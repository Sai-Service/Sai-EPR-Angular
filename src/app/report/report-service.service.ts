...
export class ReportServiceService {
  ...
  spstktrfMdSummaryReport(invcDt1,invcDt4,ouId,locId,tolocId,subInvCode){
    // alert(locId+'-----'+tolocId)
  ...
  SprStkTrfRecdSummaryReport(invcDt1,invcDt4,ouId,tolocId,fromlocId,subInvCode){
...
// http://localhost:8081//SparesReports/SprDbtPartyWiseDtls?toDate=21-AUG-2025&ouId=22&locId=2209
  ...
  sppurRegidetailReportSpares(fromDate,toDate,ouId,locId,deptId){
    const REQUEST_URI = this.ServerUrl +`/SparesReports/PurchaseRegisterDtls?fromDate=${fromDate}&toDate=${toDate}&ouId=${ouId}&locId=${locId}&deptId=${deptId}&mainType=`;
