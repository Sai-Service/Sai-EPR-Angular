...
@Component({
  ...
  styleUrls: ['./tools-reports.component.css']
})
export class ToolsReportsComponent implements OnInit {
  toolsReportForm: FormGroup;
  ...
  constructor(private fb: FormBuilder, private router: Router, private service: MasterService, private location1: Location, private router1: ActivatedRoute, private reportService: ReportServiceService) {
    this.toolsReportForm = this.fb.group({
      fromDate: [''],
      toDate: [],
      OUCode: [''],
      locCode: [''],
    ...
    this.service.subInvCode2(sessionStorage.getItem('deptId'), sessionStorage.getItem('divisionId')).subscribe(
      data => {
        ...
        if (this.subInvCode.subInventoryCode != null) {
          ...
          this.toolsReportForm.patchValue({ subInventory: this.subInvCode.subInventoryCode })
        }
        ...
        this.service.ItemMainTypeLst(sessionStorage.getItem('divisionId'))
         ...
         this.toolsReportForm.patchValue({ userName: sessionStorage.getItem('ticketNo') })
  ...
  reportDetails(reportName) {
    ...
    if (reportName === 'gstPurRegister') {
      this.reportName = 'Tools Purchase Register Details';
      ...
      this.reportName = 'Tools Purchase Register - Summary';
      if (Number(sessionStorage.getItem('deptId')) === 4) {
        this.isVisibleDepartmentList = true;
      }
      this.isVisibleGSTPurchaseRegister = true;
      ...
      this.reportName = 'Tools Consumption Summary(Labour Based)';
      ...
      this.reportName = 'Tools Stock Ledger';
      this.isVisibleonlyLocationCode = false;
      this.isVisiblegstsaiDebtors = false;
      ...
      this.reportName = 'Tools Inventory Aging Report';
      this.isVisibleGSTPurchaseRegister = false;
      this.isVisibleonlyLocationCode = false;
      this.isVisiblespClosingStockAsOndate=false;
      this.isVisiblegstsaiDebtors = false;
      ...
      this.reportName = 'Tools Closing Stock Report';
      ...
      this.reportName = 'Tools Closing Stock Summary';
      ...
      this.reportName = 'Tools Consumption Detail Report';
      this.isVisibleGSTPurchaseRegister = false;
      this.isVisibleonlyLocationCode = false;
      this.isVisiblespClosingStockAsOndate=false;
      this.isVisiblegstsaiDebtors = false;
      ...
      this.reportName = 'Tools Stock Adjustment Report';
      this.isVisibleGSTPurchaseRegister = false;
      this.isVisibleonlyLocationCode = false;
      this.isVisiblespClosingStockAsOndate=false;
      this.isVisiblegstsaiDebtors = false;
      ...
      this.reportName = 'Tools Stock Transfer Made Detail Report';
      this.isVisibleGSTPurchaseRegister = false;
      this.isVisibleonlyLocationCode = false;
      this.isVisiblespClosingStockAsOndate=false;
      this.isVisiblegstsaiDebtors = false;
      ...
      this.reportName = 'Tools Stock Transfer Made Summary Report';
      this.isVisibleGSTPurchaseRegister = false;
      this.isVisibleonlyLocationCode = false;
      this.isVisiblespClosingStockAsOndate=false;
      this.isVisiblegstsaiDebtors = false;
      ...
      this.reportName = 'Tools Stock Transfer Received Detail Report';
      this.isVisibleGSTPurchaseRegister = false;
      this.isVisibleonlyLocationCode = false;
      this.isVisiblespClosingStockAsOndate=false;
      this.isVisiblegstsaiDebtors = false;
      ...
      this.reportName = 'Tools Stock Transfer Received Summary Report';
      this.isVisibleGSTPurchaseRegister = false;
      this.isVisibleonlyLocationCode = false;
      this.isVisiblespClosingStockAsOndate=false;
      this.isVisiblegstsaiDebtors = false;
      ...
      this.reportName = 'Tools Closing Stock As On Date';
      this.isVisibleGSTPurchaseRegister = false;
      this.isVisibleonlyLocationCode = false;
  ...
  reportParameter(reportName) {
    ...
    var purStDt = this.toolsReportForm.get('fromDate').value;
    var fromDate = this.pipe.transform(purStDt, 'dd-MMM-yyyy');
    var toDate1 = this.toolsReportForm.get('toDate').value;
    var toDate = this.pipe.transform(toDate1, 'dd-MMM-yyyy');
    var locId = this.toolsReportForm.get('locId').value;
    var fromlocId = this.toolsReportForm.get('fromLocId').value;
    var tolocId = this.toolsReportForm.get('tolocId').value;
    var deptId = this.toolsReportForm.get('deptId').value;
    var userName = this.toolsReportForm.get('userName').value;
    var segment = this.toolsReportForm.get('segment').value;
    var subInventory = this.toolsReportForm.get('subInventory').value;
    var tolocId = this.toolsReportForm.get('tolocId').value;
    ...
    var fDate =this.toolsReportForm.get('fromDate').value;
    var tDate =this.toolsReportForm.get('toDate').value;


    if (reportName === 'Tools Purchase Register Details') {

      this.fromToDateValidation(fDate,tDate); if(this.rptValidation==false){return;}

      if (Number(sessionStorage.getItem('deptId')) === 4) {
        const fileName = 'Tools Purchase Register Details-' +  fromDate + '-TO-' + toDate + '.xls';
        const EXT = fileName.substr(fileName.lastIndexOf('.') + 1);
        this.reportService.sppurRegidetailReportPT(fromDate, toDate, sessionStorage.getItem('ouId'), locId, deptId,'MASPR')
          .subscribe(data => {
            saveAs(new Blob([data], { type: MIME_TYPES[EXT] }), fileName);
            this.dataDisplay = ''
            this.closeResetButton = true;
        ...
        const fileName = 'Tools Purchase Register Details-' +  fromDate + '-TO-' + toDate + '.xls';
        const EXT = fileName.substr(fileName.lastIndexOf('.') + 1);
        this.reportService.sppurRegidetailReportSparesPT(fromDate, toDate, sessionStorage.getItem('ouId'), locId, sessionStorage.getItem('deptId'),'MASPR')
          .subscribe(data => {
            saveAs(new Blob([data], { type: MIME_TYPES[EXT] }), fileName);
            this.dataDisplay = ''
            this.closeResetButton = true;
    ...
    else if (reportName === 'Tools Purchase Register - Summary') {
      this.fromToDateValidation(fDate,tDate); if(this.rptValidation==false){return;}

      const fileName = 'Tools Purchase Register - Summary-' + sessionStorage.getItem('locName').replace(' ', '') + '-' + fromDate + '-TO-' + toDate + '.xls';
      const EXT = fileName.substr(fileName.lastIndexOf('.') + 1);
      if (Number(sessionStorage.getItem('deptId')) === 4) {
    ...
    else if (reportName === 'Tools Stock Ledger') {
      this.fromToDateValidation(fDate,tDate); if(this.rptValidation==false){return;}
       if (Number(sessionStorage.getItem('deptId')) === 4) {
     ...
     else if (reportName === 'Tools Inventory Aging Report') {
      this.isDisabled1=false;
      this.rptValidation=true;
      var spInvAging1 = this.toolsReportForm.get('spInvAging1').value;
      var spInvAging2 = this.toolsReportForm.get('spInvAging2').value;
      var spInvAging3 = this.toolsReportForm.get('spInvAging3').value;
      ...
      const fileName = 'Tools Inventory Aging Report-' +  '.xls';
      const EXT = fileName.substr(fileName.lastIndexOf('.') + 1);
      if (Number(sessionStorage.getItem('deptId')) === 4) {
    ...
    else if (reportName === 'Tools Closing Stock Report') {
      ...
      var issCategory =this.toolsReportForm.get('issCatg').value;
    ...
    else if (reportName === 'Tools Stock Adjustment Report') {
      this.fromToDateValidation(fDate,tDate); if(this.rptValidation==false){return;}

      const fileName = 'Tools Misc Issue Receipt Report-' +  fromDate + '.xls';
      const EXT = fileName.substr(fileName.lastIndexOf('.') + 1);
      if (Number(sessionStorage.getItem('deptId')) === 4) {
        this.reportService.PaintparesMiscIssueReceiptReportPT(fromDate, toDate, locId,sessionStorage.getItem('ouId'),'MASPR')
          .subscribe(data => {
            saveAs(new Blob([data], { type: MIME_TYPES[EXT] }), fileName);
            this.isDisabled1 = false;
            this.closeResetButton = true;
    ...
    else if (reportName === 'Tools Stock Transfer Made Detail Report') {
      this.fromToDateValidation(fDate,tDate); if(this.rptValidation==false){return;}
    ...
    else if (reportName === 'Tools Stock Transfer Made Summary Report') {
      this.fromToDateValidation(fDate,tDate); if(this.rptValidation==false){return;}
    ...
    else if (reportName === 'Tools Stock Transfer Received Detail Report') {
      this.fromToDateValidation(fDate,tDate); if(this.rptValidation==false){return;}
    ...
    else if (reportName === 'Tools Spares Stock Transfer Received Summary Report') {
      this.fromToDateValidation(fDate,tDate); if(this.rptValidation==false){return;}
    ...
    else if (reportName==='Tools Closing Stock As On Date'){
      // const fileName = 'PAINT Closing Stock As On Date-' +  '-TO-' + '.xls';
      const fileName = 'Tools-Closing Stock - ' +sessionStorage.getItem('locName').trim() +' As On ' +  toDate + '.xls';
    ...
    // Stock-Summary-OuWise
    else if (reportName === 'Tools Closing Stock Summary') {
      // alert ('reportName---'+reportName)

      const fileName = 'Tools-Closing-StockSummary-' + sessionStorage.getItem('ouName').trim() + '.xls';
      // alert (fileName)
      const EXT = fileName.substr(fileName.lastIndexOf('.') + 1);
      if (Number(sessionStorage.getItem('deptId')) === 4) {
        this.reportService.paintclosingstockSummaryPT(sessionStorage.getItem('ouId'),subInventory,'MASPR')
          .subscribe(data => {
            saveAs(new Blob([data], { type: MIME_TYPES[EXT] }), fileName);
            this.isDisabled1 = false;
            this.closeResetButton = true;
      ...
      // alert ('reportName---'+reportName)
      //itemMasterList
      var subtp =this.toolsReportForm.get('subTp').value;
      var maintp =this.toolsReportForm.get('mainTp').value;
    ...
    // ==============================================
      ...
      const fileName = 'Tools-Stock Taking-Blank Format-' + sessionStorage.getItem('locName').trim() + '.xls';
      const EXT = fileName.substr(fileName.lastIndexOf('.') + 1);
      if (Number(sessionStorage.getItem('deptId')) === 4) {
      ...
      const fileName = 'Tools-Stock Taking-Detail Format-' + sessionStorage.getItem('locName').trim() + '.xls';
      const EXT = fileName.substr(fileName.lastIndexOf('.') + 1);
      if (Number(sessionStorage.getItem('deptId')) === 4) {
      ...
      const fileName = 'Tools-Stock Taking-Upload Format-' + sessionStorage.getItem('locName').trim() + '.xls';
      const EXT = fileName.substr(fileName.lastIndexOf('.') + 1);
      if (Number(sessionStorage.getItem('deptId')) === 4) {
        ...
        this.reportService.paintStockTakingReport(sessionStorage.getItem('locId'),subInventory,'upload')
          ...
          var compileName =this.toolsReportForm.get('compileCode').value;
  ...
  onOptionsLocation(event) {
    // alert("From Location : "+ event +","+this.toolsReportForm.get('locCode').value);
    this.toolsReportForm.patchValue({ locId: event })
    // this.toolsReportForm.patchValue({ fromLocId: event })

    if(event>0){
      var x=this.toolsReportForm.get('locCode').value;
      var y=this.toolsReportForm.get('tolocCode').value;
      if(x===y) {alert ("From/To Locations Should not be Same...");
       this.toolsReportForm.get('locCode').reset();
      return;
    }}
    }
  ...
  onOptionsToLocation(event) {
    ...
    this.toolsReportForm.patchValue({ tolocId: event });
    if(event>0){
      var x=this.toolsReportForm.get('locCode').value;
      var y=this.toolsReportForm.get('tolocCode').value;
      if(x===y) {alert ("From/To Locations Should not be Same...");
       this.toolsReportForm.get('tolocCode').reset();
      return;
    }}
  }
  ...
  onOptionsDepartmentList(event: string) {
    ...
    this.toolsReportForm.patchValue({ deptId: deptList.cmnTypeId })
  }
