...
@NgModule({
  declarations: [PaintIssueDpComponent, PaintCreationComponent, PaintMixingMasterComponent, PaintPurchaseOrderComponent, PaintPoReceiptComponent, PaintPanelMasterComponent, PaintItemMasterComponent],
  imports: [
    CommonModule,
    PaintRoutingModule,
    ReactiveFormsModule,
