...
@Component({
  selector: 'app-pump-supplier-master',
  templateUrl: './pump-supplier-master.component.html',
  styleUrls: ['./pump-supplier-master.component.css']
})
export class PumpSupplierMasterComponent implements OnInit {
