...
Select(cmId: number) {
  ...
  if (select) {
    ...
    this.pumpTankMasterForm.get('status').enable();
...
CheckDataValidations(){
  ...
  formValue.tankDescreption=this.tankDescreption.toUpperCase();
  ...
  if (formValue.tankDescreption===undefined || formValue.tankDescreption===null || formValue.tankDescreption.trim()==='' )
  {
    this.checkValidation=false; 
