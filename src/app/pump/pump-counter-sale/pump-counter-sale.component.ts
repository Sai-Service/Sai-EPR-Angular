...
@Component({
  selector: 'app-pump-counter-sale',
  templateUrl: './pump-counter-sale.component.html',
  styleUrls: ['./pump-counter-sale.component.css'],
...
export class PumpCounterSaleComponent implements OnInit {

  itemSeg: string = "";
  pumpCounterSaleOrderForm: FormGroup;
  ...
  constructor(private fb: FormBuilder, private location1: Location, private router1: ActivatedRoute, private router: Router, private service: MasterService, private orderManagementService: OrderManagementService, private transactionService: TransactionService,) {
    this.pumpCounterSaleOrderForm = fb.group({
      emplId: [''],
      salesRepId: [''],
      classCodeType: [''],
      // uuidRef: [''],
  ...
  orderlineDetailsArray(): FormArray {
    return <FormArray>this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList')
  }
  ...
  TaxDetailsArray(): FormArray {
    return <FormArray>this.pumpCounterSaleOrderForm.get('taxAmounts')
  }
  ...
  ngOnInit(): void {
    ...
    if (Number(sessionStorage.getItem('divisionId')) === 1) {
      ...
      this.pumpCounterSaleOrderForm.patchValue({ issueCodeType1: 'Regular Sales' });
      this.pumpCounterSaleOrderForm.patchValue({ issueCode: 'CM03' });
      var concatissuetypecode = this.pumpCounterSaleOrderForm.get('issueCode').value + '-' + this.pumpCounterSaleOrderForm.get('issueCodeType1').value
      this.pumpCounterSaleOrderForm.patchValue({ issueCodeType: concatissuetypecode });
    }

    this.orderlineDetailsArray().controls[0].patchValue({ invType: 'SS_SPARES' });
    this.pumpCounterSaleOrderForm.patchValue({ disAmt: 0 })
    this.pumpCounterSaleOrderForm.patchValue({ discType: 'No Discount' })
    this.op = 'insert';
      ...
      .subscribe(
        data => {
          ...
          for (let i = 0; i < data.length; i++) {
            this.pumpCounterSaleOrderForm.patchValue({ priceListName: data[i].priceListName })
            this.pumpCounterSaleOrderForm.patchValue({ priceListId: data[i].priceListHeaderId })
          }
        }
      );
    ...
    this.sub = this.router1.params.subscribe(params => {
      ...
      if (this.orderNumber != undefined) {
        ...
        this.pumpCounterSaleOrderForm.get('orderNumber').disable();
  ...
  pumpCounterSaleOrder(pumpCounterSaleOrderForm: any) {
  }
        ...
        data => {
          if (data.code === 200) {
            ...
            if (data.obj.discType === 'Header Level Discount') {
              ...
              this.pumpCounterSaleOrderForm.patchValue({ disPer: data.obj.disPer });
              this.pumpCounterSaleOrderForm.get('disPer').disable();
            }
            ...
            let control = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList') as FormArray;
            let control1 = this.pumpCounterSaleOrderForm.get('taxAmounts') as FormArray;
            ...
            this.pumpCounterSaleOrderForm.patchValue(data.obj);
            // let controlNew = this.pumpCounterSaleOrderForm.get('taxAmounts') as FormArray;
            ...
            var taxItemsArray = this.pumpCounterSaleOrderForm.get('taxAmounts').value;
            ...
            this.pumpCounterSaleOrderForm.patchValue({ trxNumber: data.obj.trxNumber })
            ...
            this.pumpCounterSaleOrderForm.patchValue({ name: data.obj.billLocName });
            this.pumpCounterSaleOrderForm.patchValue({ trxNumber: data.obj.trxNumber })
            this.transactionTypeName = data.obj.transactionTypeName;
            for (let k = 0; k < data.obj.oeOrderLinesAllList.length; k++) {
              this.pumpCounterSaleOrderForm.patchValue({ baseAmt: this.lstgetOrderLineDetails[k].baseAmt });
            ...
            for (let k = 0; k < data.obj.taxAmounts.length; k++) {
              let controlinv = this.pumpCounterSaleOrderForm.get('taxAmounts') as FormArray;
              (controlinv.controls[k]).patchValue({
                totTaxAmt: data.obj.taxAmounts[k].totTaxAmt,
              });
              this.TaxDetailsArray().disabled;
            }
            // this.pumpCounterSaleOrderForm.patchValue({ orderedDate: data.obj.orderedDate });
            this.pumpCounterSaleOrderForm.get('orderedDate').disable();
            ...
            this.pumpCounterSaleOrderForm.controls['emplId'].patchValue(Number(sessionStorage.getItem('emplId')));
            ...
            if (this.allDatastore.createOrderType === 'Pick Ticket' || this.allDatastore.createOrderType === 'Sales Order' && this.allDatastore.flowStatusCode === 'BOOKED') {
              this.pumpCounterSaleOrderForm.get('custName').disable();
              this.pumpCounterSaleOrderForm.get('mobile1').disable();
              this.pumpCounterSaleOrderForm.get('refCustNo').disable();
              this.pumpCounterSaleOrderForm.get('custPoDate').disable();
              this.pumpCounterSaleOrderForm.get('custPoNumber').disable();
              this.pumpCounterSaleOrderForm.get('custAccountNo').disable();
              ...
              this.displaypickTicketUpdate = false;
              this.displayViewGatePass = true;
              this.pumpCounterSaleOrderForm.disable();
              this.TaxDetailsArray().disable();
              this.pumpCounterSaleOrderForm.get('boxQty').enable();
              this.pumpCounterSaleOrderForm.get('driverName').enable();
              this.pumpCounterSaleOrderForm.get('vehNo').enable();
              ...
              this.pumpCounterSaleOrderForm.enable();
              ...
              this.pumpCounterSaleOrderForm.get('custPoNumber').disable();
              this.pumpCounterSaleOrderForm.get('custAccountNo').disable();
              this.pumpCounterSaleOrderForm.get('custAddress').disable();
            ...
            if (data.obj.custName.includes(('CSCASH')) && Number(sessionStorage.getItem('divisionId')) === 2) {
              ...
              if (data.obj.cntrOrdCustName != null) {
                ...
                this.pumpCounterSaleOrderForm.patchValue({ walkCustName: temp[0] });
                this.pumpCounterSaleOrderForm.patchValue({ walkCustPan: temp[1] });
                this.pumpCounterSaleOrderForm.patchValue({ walkCustaddres: temp[2] });
              }
            }
                ...
                .subscribe(
                  data => {
                    if (data.code === 200) {
                      ...
                      // this.pumpCounterSaleOrderForm.patchValue({ creditAmt: newCrmAmt1 });
                      this.pumpCounterSaleOrderForm.patchValue({ creditAmt: data.obj.creditAmt });
                      this.pumpCounterSaleOrderForm.patchValue({ outStandingAmt: newCrmAmt1 });
                      this.pumpCounterSaleOrderForm.patchValue({ creditDays: data.obj.creditDays });
                      this.pumpCounterSaleOrderForm.patchValue({ daysMsg: data.obj.daysMsg });
                      var typ = this.pumpCounterSaleOrderForm.get('transactionTypeName').value;
                      if (!typ.includes('Accessories Sale')) {
                        if (this.pumpCounterSaleOrderForm.get('daysMsg').value.includes('Exceeded')) {
            ...
            if (data.obj.orderStatus === 'INVOICED' && data.obj.gatePassYN === 'N') {
              ...
              this.pumpCounterSaleOrderForm.get('driverName').enable();
              this.pumpCounterSaleOrderForm.get('vehNo').enable();
              this.pumpCounterSaleOrderForm.get('remarks').disable();
            ...
            this.pumpCounterSaleOrderForm.patchValue(({ orderedDate: data.obj.orderedDate }));
            this.pumpCounterSaleOrderForm.patchValue(({ custPoDate: data.obj.custPoDate }));
          }
          else {
            if (data.code) {
              alert(data.message);
  ...
  downloadCSINV() {
    var invoiceNumber = this.pumpCounterSaleOrderForm.get('trxNumber').value;
    const fileName = 'download.pdf';
    // const EXT = fileName.substr(fileName.lastIndexOf('.') + 1);
  ...
  pickTicketupdateFunction() {
    ...
    // var orderLines = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList').getRawValue;
    var orderLines1 = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList') as FormArray;
    ...
    var totAmt = this.pumpCounterSaleOrderForm.get('totAmt').value;
    var crdAmt = this.pumpCounterSaleOrderForm.get('creditAmt').value;
    var typ = this.pumpCounterSaleOrderForm.get('transactionTypeName').value;
    var subtyp = this.pumpCounterSaleOrderForm.get('createOrderType').value;
    var outAmt:number=0;
     outAmt=this.pumpCounterSaleOrderForm.get('outStandingAmt').value
    // if (!typ.includes('Accessories Sale')) {
      if(outAmt>crdAmt){
        // alert(outAmt+crdAmt)
    ...
    let jsonData = this.pumpCounterSaleOrderForm.getRawValue();

    jsonData.orderedDate = this.pipe.transform(this.now, 'yyyy-MM-dd');
    jsonData.refCustNo = this.pumpCounterSaleOrderForm.get('refCustNo').value;
    jsonData.custPoNumber = this.pumpCounterSaleOrderForm.get('custPoNumber').value;
    jsonData.custPoDate = this.pumpCounterSaleOrderForm.get('custPoDate').value;
    ...
    this.orderManagementService.UpdateCounterSaleInv(JSON.stringify(salesObj)).subscribe((res: any) => {
      if (res.code === 200) {
        ...
        if (res.code === 400) {
          alert(res.message + 'res.message');
          this.pumpCounterSaleOrderForm.reset();
          this.dataDisplay = ''
          this.closeResetButton = true;
        }
      }
  ...
  generateGatePass() {
    const formValue: IGatePass = this.pumpCounterSaleOrderForm.value;
  ...
  gatePassViewFn() {
    var orderNumber = this.pumpCounterSaleOrderForm.get('orderNumber').value;
    const fileName = 'download.pdf';
    const EXT = fileName.substr(fileName.lastIndexOf('.') + 1);
  ...
  onOptionsSelectedCustomerType(SelectCustType: any) {
    if (SelectCustType == 'New Customer') {
      ...
      // (<any>this.pumpCounterSaleOrderForm.get('accountNo')).nativeElement.focus();
    }
  }
  ...
  onOptionsSelectedTL(createOrderType) {
    ...
    if (createOrderType === 'Pick Ticket' || createOrderType === 'Direct Invoice') {
      // Sales Order
      this.displaysalesRepName = true;
      this.pumpCounterSaleOrderForm.get('othRefNo').disable();
      this.pumpCounterSaleOrderForm.get('salesRepName').reset();
      this.pumpCounterSaleOrderForm.get('tlName').reset();
    }
    else {
      if (createOrderType === 'Sales Order') {
        this.displaysalesRepName = false;
        this.pumpCounterSaleOrderForm.get('othRefNo').enable();
        this.othRefNoSearch();
      }
    }
  }
      ...
      .subscribe(
        data => {
          if (data.code === 200) {
            ...
            this.pumpCounterSaleOrderForm.patchValue({ tcsYN: data.obj.tcsYN });
            this.pumpCounterSaleOrderForm.patchValue({ custName: data.obj.custName });
            this.pumpCounterSaleOrderForm.patchValue({ customerId: data.obj.customerId });

            this.pumpCounterSaleOrderForm.patchValue({ tcsPer: data.obj.tcsPer });
            this.pumpCounterSaleOrderForm.patchValue({ custAccountNo: custAccountNo });
            ...
            this.pumpCounterSaleOrderForm.patchValue({ paymentType: select.lookupValue })
            ...
            for (let i = 0; i < this.custSiteList.length; i++) {
              ...
              if (this.custSiteList.length === 1 && Number(this.custSiteList[i].ouId) === Number(sessionStorage.getItem('ouId'))) {
                ...
                this.pumpCounterSaleOrderForm.patchValue({ name: this.custSiteList[0].siteName });
              ...
              if (this.custSiteList.length > 1) {
                if (Number(this.custSiteList[i].ouId) === Number(sessionStorage.getItem('ouId'))) {
                  this.pumpCounterSaleOrderForm.patchValue({ name: this.custSiteList[i].siteName });
                  this.pumpCounterSaleOrderForm.get('name').enable()
            ...
            if (custName.includes(('CSCASH')) && Number(sessionStorage.getItem('divisionId')) === 2) {
              this.displaywalkingCustomer = false;
              this.pumpCounterSaleOrderForm.patchValue({ discType: 'Header Level Discount' });
              this.displaydisPer = false;
              let select = this.orderTypeList.find(d => d.transactionTypeName.includes('Cash'));
              this.pumpCounterSaleOrderForm.patchValue({ transactionTypeName: select.transactionTypeName });
              this.pumpCounterSaleOrderForm.patchValue({ walkCustPan: 'Applied For' });
              this.pumpCounterSaleOrderForm.patchValue({ createOrderType: 'Direct Invoice' });
              this.pumpCounterSaleOrderForm.get('transactionTypeName').disable();
              this.pumpCounterSaleOrderForm.get('createOrderType').disable();
            }
            else {
              this.pumpCounterSaleOrderForm.get('disPer').disable();
            }
            ...
            if (Number(sessionStorage.getItem('ouId')) === 22 && data.obj.classCodeType === 'EXPORTER') {
              ...
              this.pumpCounterSaleOrderForm.patchValue({ remarks: '22 - Export Order' });
              this.pumpCounterSaleOrderForm.get('remarks').disable();
            }
      ...
      .subscribe(
        data => {
          if (data.code === 200) {
            ...
            this.pumpCounterSaleOrderForm.patchValue({ salesRepId: data.obj.emplId });
            this.pumpCounterSaleOrderForm.patchValue({ salesRepName: salesExicustive })
          }
          else if (data.code === 400) {
            this.pumpCounterSaleOrderForm.patchValue({ salesRepId: Number(sessionStorage.getItem('emplId')) });
            this.pumpCounterSaleOrderForm.patchValue({ salesRepName: (sessionStorage.getItem('ticketNo')) });
  ...
  onOptionsSelecteddisPer() {
    var disPer1 = this.pumpCounterSaleOrderForm.get('disPer').value
    // alert(disPer1);
  ...
  panCardWalding(event: any) {
    this.orderManagementService.searchByPanNumber(this.pumpCounterSaleOrderForm.get('walkCustPan').value)
      .subscribe(
        data => {
          if (data.code === 200) {
            if (data.obj.length >= 0) {
              alert(data.message + ' ' + 'Customer Account Number' + ' ' + data.obj.accountNo)
              this.pumpCounterSaleOrderForm.get('walkCustPan').reset();
            }
  ...
  walkcustomermerge(event: any) {
    var contactName = this.pumpCounterSaleOrderForm.get('walkCustName').value + '#' + this.pumpCounterSaleOrderForm.get('walkCustPan').value + '#' + this.pumpCounterSaleOrderForm.get('walkCustaddres').value
    this.pumpCounterSaleOrderForm.patchValue({ cntrOrdCustName: contactName })
  }
  ...
  onOptionsSelectedcustSiteName(siteName) {
    ...
    if (selSite.taxCategoryName=='Sales-IGST' && selSite.state=='MAHARASHTRA'){
      alert('State name & attached customer tax category is diiferent.. Please co-ordinate with IT Team');
      this.pumpCounterSaleOrderForm.patchValue({mobile1:' ',custAddress:' ',taxCategoryName:' '})
      return;
    }
    ...
    if (selSite.ouId != (sessionStorage.getItem('ouId'))) {
      ...
      this.pumpCounterSaleOrderForm.patchValue(selSite);
      ...
      this.pumpCounterSaleOrderForm.patchValue({ creditAmt: selSite.creditAmt });
      if (selSite.disPer != null) {
        // alert(selSite.disPer)
        this.pumpCounterSaleOrderForm.patchValue({ discType: 'Header Level Discount' })
        this.pumpCounterSaleOrderForm.patchValue({ disPer: selSite.disPer })
      ...
      this.service.crediteLimitFn(this.selCustomer.customerId, sessionStorage.getItem('locId'), selSite.customerSiteId)
        .subscribe(
          data => {
            if (data.code === 200) {
              // alert(data.obj);
              var credAmt = this.pumpCounterSaleOrderForm.get('creditAmt').value;
    ...
    var custName = this.pumpCounterSaleOrderForm.get('custName').value;
    // debugger;
    if (custName.includes(('CSCASH')) && Number(sessionStorage.getItem('divisionId')) === 2) {
      this.displaywalkingCustomer = false;
      this.pumpCounterSaleOrderForm.patchValue({ discType: 'Header Level Discount' });
      ...
      this.pumpCounterSaleOrderForm.patchValue({ createOrderType: createOrderList[0].code });
      this.pumpCounterSaleOrderForm.get('transactionTypeName').disable();
      // this.pumpCounterSaleOrderForm.get('createOrderType').disable();
    }
    ...
    // this.pumpCounterSaleOrderForm.patchValue({ createOrderType: 'Pick Ticket' });
  }
  ...
  salesOrderDetails(event) {
    ...
    this.pumpCounterSaleOrderForm.patchValue({othRefNo:orderNumber})
  }


  othRefNoSearch() {
    var customerId = this.pumpCounterSaleOrderForm.get('customerId').value;
    this.orderManagementService.othRefNoSearchFn(sessionStorage.getItem('locId'), 1, customerId)
      .subscribe(
        data => {
          if (data.code === 200) {
            this.othRefNoSearchFnData = data.obj;
            this.pumpCounterSaleOrderForm.patchValue(this.othRefNoSearchFnData);
            ...
            for (let i = 0; i < data.obj.length; i++) {
              if (this.custAccountNo != this.othRefNoSearchFnData[i].custAccountNo1) {
                ...
                this.pumpCounterSaleOrderForm.get('othRefNo').reset()
                return;
              }
              else {
                // this.othRefNo = data.obj[i].orderNumber1;
                this.pumpCounterSaleOrderForm.patchValue({othRefNo:data.obj[i].orderNumber1})
              }
            }
          }
          else {
      ...
      .subscribe(
        data => {
          if (data.code === 200) {
            ...
            this.pumpCounterSaleOrderForm.patchValue(this.contactNoSearchData);
  ...
  get f() { return this.pumpCounterSaleOrderForm.controls }
  ...
  getGroupControllinewise(index, fieldName) {
    // alert('nam'+fieldName);
    return (<FormArray>this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList')).at(index).get(fieldName);
  ...
  validate(index: number, qty1) {
    // var trxLnArr = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList').value;
    var trxLnArr1 = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList') as FormArray;
    ...
    var transactionTypeName = this.pumpCounterSaleOrderForm.get('transactionTypeName').value;
    var createOrderType = this.pumpCounterSaleOrderForm.get('createOrderType').value;
  ...
  onKey(index, fldName, event) {
    ...
    if (event.keyCode != 13) {
      ...
      // var arrayControl = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList').value;
      var arrayControlNew = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList') as FormArray;
      ...
      this.service.taxCalforItem(itemId, taxCategoryId, disAmt1, baseAmt)
        .subscribe(
          (data: any[]) => {
            ...
            // taxAmt: Math.round((sum + Number.EPSILON) * 100) / 100,
            let controlinv1 = this.pumpCounterSaleOrderForm.get('taxAmounts') as FormArray;
            let distAmtArray = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList') as FormArray;
            ...
            this.pumpCounterSaleOrderForm.get('taxAmounts').patchValue(data);
            ...
            // let taxMapData = this.pumpCounterSaleOrderForm.get('taxAmounts').value;
  ...
  onOptionsSelectedDescription(segment: string, k) {
    ...
    if (segment != undefined && segment != "") {
      ...
      this.pumpCounterSaleOrderForm.patchValue({ orderedDate: orderedDate });
      if (this.pumpCounterSaleOrderForm.get('createOrderType').value === 'Sales Order' && this.pumpCounterSaleOrderForm.get('othRefNo').value === undefined) {
        alert('Please Enter Reference Number First !');
        this.pumpCounterSaleOrderForm.get('othRefNo').enable();
        // this.orderlineDetailsArray().get('segment').disable();
        // (<any>this.pumpCounterSaleOrderForm.get('othRefNo')).nativeElement.focus();
      }
      else {
        ...
        //this.pumpCounterSaleOrderForm.patchValue({ itemId: select.itemId })
        if (segment != undefined) {
          this.displaysalesRepName = true;
          this.pumpCounterSaleOrderForm.get('custAccountNo').disable();
          this.pumpCounterSaleOrderForm.get('name').disable();
          this.pumpCounterSaleOrderForm.get('custName').disable();
          this.pumpCounterSaleOrderForm.get('mobile1').disable();
          this.pumpCounterSaleOrderForm.get('refCustNo').disable();
          this.pumpCounterSaleOrderForm.get('custPoDate').disable();
          ...
          var custtaxCategoryName = this.pumpCounterSaleOrderForm.get('taxCategoryName').value;
          let isExportCust = "N";
          // alert(this.custClassCode);
          if (this.custClassCode.includes("EXPORTER") && Number(sessionStorage.getItem('ouId')) === 22) {
            isExportCust = "Y";
          }
          var priceListId = this.pumpCounterSaleOrderForm.get('priceListId').value;
                  ...
                  if (data.code === 200) {
                    ...
                    for (let i = 0; i < data.obj.length; i++) {
                      ...
                      if (taxCatNm.includes('Sale-S&C') || taxCatNm.includes('Sales-S&C')) {
                        ...
                        // if (this.pumpCounterSaleOrderForm.get('issueCodeType').value.includes('Only Oil Part') && data.obj[i].uom === 'LTR' && Number(sessionStorage.getItem('divisionId')) === 2) {
                        //   (controlinv.controls[k]).patchValue({
                        //     disPer: 0,
                        //     disAmt: 0
                        //   })
  ...
  AvailQty(i, itemId, calledFrom) {
    var trxLnArr = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList').value;
    var trxLnFormArr = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList') as FormArray;
    if (itemId === undefined) {
  ...
  pickTicketInvoiceFunction() {
    ...
    var tcsPer = this.pumpCounterSaleOrderForm.get('tcsPer').value;
    var ordTotAmt = this.pumpCounterSaleOrderForm.get('totAmt').value;
    var tcsCal = Math.round((ordTotAmt * tcsPer / 100 + Number.EPSILON) * 100) / 100;
    this.pumpCounterSaleOrderForm.patchValue({ 'tcsAmt': tcsCal });
    if (tcsCal > 0) {
      alert('Added TCS-->' + tcsCal);
    }
    this.dataDisplay = 'Invoice Genration in progress....Do not refresh the Page';
    // this.isDisabled10 = true;
    // var formValue = this.pumpCounterSaleOrderForm
    // const formValue1: ISalesBookingForm = this.transData(this.pumpCounterSaleOrderForm.value);
    // console.log(formValue);
    var orderedDate = this.pumpCounterSaleOrderForm.get('orderedDate').value;
    var custPoDate = this.pumpCounterSaleOrderForm.get('custPoDate').value;
    var formValue = this.pumpCounterSaleOrderForm.getRawValue();
    var orderLines = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList').value;
    ...
    this.orderManagementService.pickTicketInvoiceFun(formValue).subscribe((res: any) => {
      if (res.code === 200) {
        ...
        // this.orderNumber=this.pumpCounterSaleOrderForm.get('orderNumber').value;
        // console.log(this.orderNumber);
        // this.OrderFind(this.orderNumber);
      } else {
        if (res.code === 400) {
  ...
  counterSaleOrderSave() {
    ...
    this.isDisabled = true;
    var cusTaxcat = this.pumpCounterSaleOrderForm.get('taxCategoryName').value;
    // alert(cusTaxcat)
    // debugger;
    ...
    var orderLines = orderLines1.getRawValue();
    var custName = this.pumpCounterSaleOrderForm.get('custName').value;
    var walkCustName = this.pumpCounterSaleOrderForm.get('walkCustName').value;
    var walkCustPan = this.pumpCounterSaleOrderForm.get('walkCustPan').value;
    var walkCustaddres = this.pumpCounterSaleOrderForm.get('walkCustaddres').value;
    ...
    // if (this.pumpCounterSaleOrderForm.get('transactionTypeName').value =='Spares Sale - Credit' || this.pumpCounterSaleOrderForm.get('createOrderType').value=='Pick Ticket'){
    var totAmt = this.pumpCounterSaleOrderForm.get('totAmt').value;
    var crdAmt = this.pumpCounterSaleOrderForm.get('creditAmt').value;
    var typ = this.pumpCounterSaleOrderForm.get('transactionTypeName').value;
    var subtyp = this.pumpCounterSaleOrderForm.get('createOrderType').value;
  ...
  updateTotAmtPerline(lineIndex) {
    var formArr = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList') as FormArray;
    ...
    this.pumpCounterSaleOrderForm.patchValue({ 'subtotal': basicAmt });
    disAmt = Math.round(((disAmt) + Number.EPSILON) * 100) / 100;
    this.pumpCounterSaleOrderForm.patchValue({ 'discAmt': disAmt });
    taxAmt1 = Math.round(((taxAmt1) + Number.EPSILON) * 100) / 100;
    this.pumpCounterSaleOrderForm.patchValue({ 'totTax': taxAmt1 });
    totAmt = Math.round(((totAmt) + Number.EPSILON) * 100) / 100;
    this.pumpCounterSaleOrderForm.patchValue({ 'totAmt': totAmt });
    this.pumpCounterSaleOrderForm.patchValue({ 'tcsAmt': tcsAmt1 });
    ...
    // debugger;
    // alert(outTotAmt);
    this.pumpCounterSaleOrderForm.patchValue({ 'outStandingAmt': outTotAmt });
    if (!typ.includes('Accessories Sale')) {
      // alert(crdAmt)
      // if (crdAmt >0){
  ...
  RemoveRow(OrderLineIndex) {
    ...
    var formVal = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList').value;
    var formArr = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList') as FormArray;
    var basicAmt = 0;
    var taxAmt1 = 0;
    var totAmt = 0;
  ...
  updateLineOnCancel(i) {
    var trxArrVal = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList').value;
    var trxArr = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList') as FormArray;
    var taxArrVal = this.pumpCounterSaleOrderForm.get('taxAmounts').value;
    var taxArrValpatch = this.pumpCounterSaleOrderForm.get('taxAmounts') as FormArray;
  ...
  // addDiscount(i) {
  //   var invLine = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList').value;
  //   var arrayControltaxAmounts = this.pumpCounterSaleOrderForm.get('taxAmounts').value;
  ...
  //   var patch = this.pumpCounterSaleOrderForm.get('taxAmounts') as FormArray;
  //   // control.clear();
  ...
  //           this.pumpCounterSaleOrderForm.get('taxAmounts').patchValue(this.taxCalforItem);
  //         }
  //         this.patchResultList(this.poLineTax, this.taxCalforItem);
  //         var arrayupdateTaxLine = this.pumpCounterSaleOrderForm.get('taxAmounts').value;
  ...
  addDiscount(lnNo) {
    // alert(lnNo)
    // debugger;
    let controlinv2 = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList') as FormArray;
    ...
    var patch = this.pumpCounterSaleOrderForm.get('taxAmounts') as FormArray;
    var arrayControlTax = this.pumpCounterSaleOrderForm.get('taxAmounts').value;
  ...
  validateNum(index, j) {
    var arrayControl = this.pumpCounterSaleOrderForm.get('taxAmounts').value
  ...
  taxDetails(op, i, taxCategoryId) {
    ...
    // let controlinv1 = this.pumpCounterSaleOrderForm.get('taxAmounts') as FormArray;
    // debugger;
    var taxItems1: any[] = this.pumpCounterSaleOrderForm.get('taxAmounts').value;
    if (op === 'Search') {
      // alert(op);
  ...
  patchResultList(i, taxCalforItem, invLineNo, invLineItemId) {
    ...
    let control = this.pumpCounterSaleOrderForm.get('taxAmounts') as FormArray
    control.clear();
  ...
  onOptioncustTypeSelected(event: any) {
    this.PersonType = this.pumpCounterSaleOrderForm.get('custType').value;
  ...
  onKey1(event: any) {
    ...
    var person = this.pumpCounterSaleOrderForm.get('custType').value;
    // alert(person);
    if (person === 'Person') {
      this.custName = aaa;
    }
  ...
  //   return (<FormArray>this.pumpCounterSaleOrderForm.get(arrayname)).at(index).get(fieldName);
  // }
  ...
  onOptionsSelectedTransactionType(transactionTypeName: string) {
    ...
    if (transactionTypeName != undefined) {
      ...
      // alert(this.op)
      if (this.op != 'Search') {
        if (this.pumpCounterSaleOrderForm.get('custName').value == undefined && this.pumpCounterSaleOrderForm.get('custAddress').value == undefined) {
      ...
      this.pumpCounterSaleOrderForm.patchValue({ transactionTypeId: select.transactionTypeId })
      ...
      if (transactionTypeName.includes('Cash')) {
        ...
        this.pumpCounterSaleOrderForm.patchValue({ createOrderType: selectTrx.codeDesc });
    ...
    this.service.searchCustomerByContact(contactNo)
      .subscribe(
        data => {
          ...
          this.pumpCounterSaleOrderForm.patchValue({ custAccountNo: data.obj.custAccountNo })
  ...
  Select(custAccountNo) {
    ...
    if (custAccountNo != undefined) {
      ...
      this.pumpCounterSaleOrderForm.patchValue(this.selCustomer);
      ...
      //   this.pumpCounterSaleOrderForm.patchValue({disPer: this.custSiteList[0].disPer })    }
    }
  }


  tcsCalculationAdd() {
    var arrayctrl = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList').value;
  ...
  reservePos(i) {
    ...
    var locId1 = this.pumpCounterSaleOrderForm.get('locId').value;
    ...
    var transactionType = this.pumpCounterSaleOrderForm.get('transactionTypeName').value;
  ...
  deleteReserve() {
    ...
    // var transferId = this.pumpCounterSaleOrderForm.get('uuidRef').value;
    var trxLnArr2 = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList') as FormArray;
    var trxLnArr1 = trxLnArr2.getRawValue();
  ...
  onOptionsSelectedissueTypeCode(event: any) {
    ...
    this.pumpCounterSaleOrderForm.patchValue({ issueCode: selectIssueCode.code })
    var concatissuetypecode = this.pumpCounterSaleOrderForm.get('issueCode').value + '-' + this.pumpCounterSaleOrderForm.get('issueCodeType1').value
    this.pumpCounterSaleOrderForm.patchValue({ issueCodeType: concatissuetypecode });
  }
  ...
  openTaxDetails(i: number) {
    ...
    var orLineVal = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList').value;
  ...
  //   // debugger;
  //   this.pumpCounterSaleOrderForm.get('taxAmounts').patchValue(this.lineTaxdetails.value);
  //   this.taxMap.set(this.selTaxLn, this.lineTaxdetails.value);
  //   // alert('added to map closeTaxModal..' + this.selTaxLn)
  //   this.display = 'none'; //set none css after close dialog
  //   this.myInputField.nativeElement.focus();

  //   var taxValues = this.pumpCounterSaleOrderForm.get('taxAmounts').value;
  //   var totDisc = 0;
  //   var totTax = 0;
  ...
  //     }
  //   }
  //   var controlinv1 = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList').value;
  //   var controlinv2 = this.pumpCounterSaleOrderForm.get('oeOrderLinesAllList') as FormArray;
  ...
  refreshCreadiAmt() {
    var customerId = this.pumpCounterSaleOrderForm.get('customerId').value;
    var customerSiteId = this.pumpCounterSaleOrderForm.get('customerSiteId').value;
      ...
      .subscribe(
        data => {
          if (data.code === 200) {
            ...
            var outTotAmt:number=0;
            var TotAmt:number=0;
            TotAmt=this.pumpCounterSaleOrderForm.get('totAmt').value;
