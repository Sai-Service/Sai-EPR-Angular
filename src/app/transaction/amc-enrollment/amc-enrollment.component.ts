...
export class AmcEnrollmentComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.service.salesRepNameList(sessionStorage.getItem('ouId'), sessionStorage.getItem('locId'), sessionStorage.getItem('deptId'))
      .subscribe(
        data => {
      ...
      if (schNo != null) {
        ...
        if (this.customerId > 0) {
          ...
          if (selectedValue != undefined) {
            ...
            alert("Please Enter Customer Vehilcle Registration no. and proceed.");
  ...
  validateStartKms() {
    ...
    if (startKm >= endKm || startKm <= 0) {
      alert("Enter Valid Start Kilomoeter Reading...");
